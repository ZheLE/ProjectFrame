...
public class LruCacheDetailActivity extends AppCompatActivity {
    ...
    public static void navigate(AppCompatActivity activity, View transitionImage, VenuesInfo venue) {
        Intent intent = new Intent(activity, LruCacheDetailActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lru_detail);
