 ...
 */
public class PhotoWallAdapterDemo extends ArrayAdapter<String> implements AbsListView.OnScrollListener{
    ...
    public PhotoWallAdapterDemo(Context context, int textViewResourceId, String[] objects,
                                GridView photoWall) {
