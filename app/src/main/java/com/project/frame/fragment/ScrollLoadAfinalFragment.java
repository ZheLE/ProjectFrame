...
public class ScrollLoadAfinalFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ScrollLoadLruCacheAdapter.OnItemClickListener{
...
//    private int position;
    ...
    public static ScrollLoadAfinalFragment newInstance(int position) {
        ScrollLoadAfinalFragment fragment = new ScrollLoadAfinalFragment();
        Bundle b = new Bundle();
